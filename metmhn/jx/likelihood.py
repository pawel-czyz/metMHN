...
def _lp_prim_obs(
    log_theta: jnp.ndarray, log_d_p: jnp.ndarray, state_pt: jnp.ndarray, n_prim: int
) -> jnp.ndarray:
...
__all__ = ["_lp_prim_obs", "_lp_prim_obs_az"]


@partial(jit, static_argnames=["n_prim"])
def _grad_prim_obs(
    log_theta: jnp.ndarray, log_d_p: jnp.ndarray, state_prim: jnp.ndarray, n_prim: int
